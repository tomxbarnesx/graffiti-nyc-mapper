...
User.create(first_name: "Frank", last_name: "Sinatra", email: "test@test.com", is_admin: false, birthdate: "19910313", bio: "Test account for the NYC graffiti maps project.", username: "frankiesinatra", password: "password");